...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Child Placement Intelligence Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Child Welfare Case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "child_welfare_case_records";
'use strict';
